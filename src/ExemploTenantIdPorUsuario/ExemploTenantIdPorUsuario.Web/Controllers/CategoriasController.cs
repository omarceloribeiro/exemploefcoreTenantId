...
namespace ExemploTenantIdPorUsuario.Web.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,TenantId")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,TenantId")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
